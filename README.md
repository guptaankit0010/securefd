...
Each diagram shows the complete internal flow of a module and annotates every security control, validation gate, and performance decision directly on the relevant step. The diagrams are saved as separate files for readability — open them in any Mermaid viewer or GitHub.

| Module | Diagram file |
|--------|-------------|
| Auth (signup, login, refresh, logout) | [docs/diagrams/auth-module.md](docs/diagrams/auth-module.md) |
| File (upload, list, get, delete) | [docs/diagrams/file-module.md](docs/diagrams/file-module.md) |
| Share (create, list, revoke, download) | [docs/diagrams/share-module.md](docs/diagrams/share-module.md) |
| User (list, create, update, delete) | [docs/diagrams/user-module.md](docs/diagrams/user-module.md) |
| Shared infrastructure (DB, crypto, validation, middleware, logger) | [docs/diagrams/infrastructure.md](docs/diagrams/infrastructure.md) |

**Color legend used in every diagram:**
- Red nodes — Security controls (crypto, token checks, access guards, breach responses)
- Blue nodes — Validation / input checks (schema validation, sanitization, format checks)
- Green nodes — Performance decisions (connection pools, indexes, aggregation pipelines, pagination, parallel queries)

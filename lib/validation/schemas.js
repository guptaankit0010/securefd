...
const SCHEMAS = {
  signup:      { username: { required: true, type: 'string', maxLength: 254 }, password: { required: true, type: 'string', maxLength: 128 }, role: { type: 'string', enum: ['admin','manager','viewer'] } },
  login:       { username: { required: true, type: 'string', maxLength: 254 }, password: { required: true, type: 'string', maxLength: 128 } },
  ...
  createUser:  { username: { required: true, type: 'string', maxLength: 254 }, password: { required: true, type: 'string', maxLength: 128 }, role: { required: true, type: 'string', enum: ['admin','manager','viewer'] } },
  updateUser:  { username: { type: 'string', maxLength: 254 }, password: { type: 'string', maxLength: 128 }, role: { type: 'string', enum: ['admin','manager','viewer'] } },
};
